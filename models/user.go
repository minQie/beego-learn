...
type User struct {
	...
	Gender        GenderEnum `orm:"column(gender)"           json:"gender"`   // 性别
	...
	DeleteBy      int64      `orm:"column(delete_by)"        json:"-"`        // 删除操作人id
	Deleted       bool       `orm:"column(is_deleted)"       json:"-"`        // 删除标识
}
